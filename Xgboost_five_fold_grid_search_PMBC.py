...
def find_best_param_list(X_train,y_train,X_test,y_test,data_split,nindex):
    ...
    spw = [0.2,0.6,1]
    # lr = [0.29, 0.295, 0.3]
    # ss = [0.8, 0.85, 0.9, 0.95]
    # cbt = [0.95]
    # cbl = [0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
    # spw = [1]
    # lr = [0.25, 0.255, 0.26, 0.265, 0.27, 0.275, 0.28, 0.285, 0.29]
    # ss = [0.55, 0.6, 0.65, 0.7, 0.75, 0.8]
    # cbt = [0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
    # cbl = [0.55, 0.6]
    # spw = [1]
...
if __name__ == "__main__":
    Feature = pd.read_csv('selected_PBMC_protein.csv', index_col=0)
    ...
    best_param_list = find_best_param_list(X_train,y_train,X_test,y_test,sss,2)
