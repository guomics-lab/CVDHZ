...
M1=df_PBMC31[,c(group1.sam,group0.sam)]
NA_threshold_table(M1)
...
#time1-P1/P2
t1.differprot <- linda.volcano.plot2(M1,logtransformation = F,group1 =names(M1)%in%group1.sam ,group2 = names(M1)%in%group0.sam,label1 = "Time1group1",label2 = "group0",fold_change = 2^0.25)

M2=df_PBMC31[,c(group2.sam,group0.sam)]
NA_threshold_table(M2)
...
#time1-P1/P3
linda.volcano.plot2(M2,logtransformation = F,group1 = names(M2)%in%group2.sam,group2 = names(M2)%in%group0.sam,label1 = "Time1group2",label2 = "group0",fold_change = 2^0.25)
#time1-P2/P3
M3=df_PBMC31[,c(group2.sam,group1.sam)]
NA_threshold_table(M3)
...
linda.volcano.plot2(M3,logtransformation = F,group1 = names(M3)%in%group2.sam,group2 = names(M3)%in%group1.sam,label1 = "Time1group2",label2 = "group1",fold_change = 2^0.25)
...
[1] "P46783_RPS10"            "P0DJI9_SAA2"             "P06703_S100A6"           "Q9UPU7_TBC1D2B"         
 [5] "P24723_PRKCH"            "P63313_TMSB10"           "P52848_NDST1"            "P60604_UBE2G2"          
 [9] "Q8N841_TTLL6"            "Q8NAA5_FAM211A; LRRC75A"
...
M1=df_PBMC32[,c(group1.sam,group0.sam)]
M1=M1[apply(M1[,group1.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
M1=M1[apply(M1[,group0.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
#time1-P1/P2
t1.differprot <- linda.volcano.plot2(M1,logtransformation = F,group1 =names(M1)%in%group1.sam ,group2 = names(M1)%in%group0.sam,label1 = "Time2group1",label2 = "group0",fold_change = 2^0.25)

M2=df_PBMC32[,c(group2.sam,group0.sam)]
M2=M2[apply(M2[,group2.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
M2=M2[apply(M2[,group0.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
#time1-P1/P3
linda.volcano.plot2(M2,logtransformation = F,group1 = names(M2)%in%group2.sam,group2 = names(M2)%in%group0.sam,label1 = "Time2group2",label2 = "group0",fold_change = 2^0.25)
#time1-P2/P3
M3=df_PBMC32[,c(group2.sam,group1.sam)]
M3=M3[apply(M3[,group2.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
M3=M3[apply(M3[,group1.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]

linda.volcano.plot2(M3,logtransformation = F,group1 = names(M3)%in%group2.sam,group2 = names(M3)%in%group1.sam,label1 = "Time2group2",label2 = "group1",fold_change = 2^0.25)
...
intersect(diff_time2,t1.differprot) #12个overlap
[1] "P14780_MMP9"        "O15061_SYNM"        "O43299_AP5Z1"       "O00479_HMGN4"       "Q5JS54_PSMG4"      
 [6] "Q9BPZ7_MAPKAP1"     "P68133_ACTA1"       "P05062_ALDOB"       "P0CAP2_POLR2M"      "Q8IU54_IFNL1; IL29"
[11] "Q96SN8_CDK5RAP2"    "Q9UN71_PCDHGB4" 
...
M1=df_PBMC33[,c(group1.sam,group0.sam)]
M1=M1[apply(M1[,group1.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
M1=M1[apply(M1[,group0.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
#time1-P1/P2
t1.differprot <- linda.volcano.plot2(M1,logtransformation = F,group1 =names(M1)%in%group1.sam ,group2 = names(M1)%in%group0.sam,label1 = "Time3group1",label2 = "group0",fold_change = 2^0.25)

M2=df_PBMC33[,c(group2.sam,group0.sam)]
M2=M2[apply(M2[,group2.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
M2=M2[apply(M2[,group0.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
#time1-P1/P3
linda.volcano.plot2(M2,logtransformation = F,group1 = names(M2)%in%group2.sam,group2 = names(M2)%in%group0.sam,label1 = "Time3group2",label2 = "group0",fold_change = 2^0.25)
#time1-P2/P3
M3=df_PBMC33[,c(group2.sam,group1.sam)]
M3=M3[apply(M3[,group2.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]
M3=M3[apply(M3[,group1.sam],1,function(x) {sum(is.na(x))/length(x)<0.9}),]

linda.volcano.plot2(M3,logtransformation = F,group1 = names(M3)%in%group2.sam,group2 = names(M3)%in%group1.sam,label1 = "Time3group2",label2 = "group1",fold_change = 2^0.25)
...
intersect(diff_time3,t1.differprot) #5个overlap
[1] "Q99878_HIST1H2AJ; HIST1H2AK" "P48061_CXCL12"               "Q9NRF9_POLE3"                "Q9C005_DPY30"               
[5] "Q5FWF4_ZRANB3" 
```
